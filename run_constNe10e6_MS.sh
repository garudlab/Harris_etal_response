...
outFile=~/Jensen_response/analysis/constNe106_neutrality_MS

for i in `seq 1 100`; do

~/./msdir/ms 145 1 -t $theta -r $rho $locusLength -seed $RANDOM $RANDOM $RANDOM > $file
...
elif [ "$locusLength" -eq "100000" ]; then
