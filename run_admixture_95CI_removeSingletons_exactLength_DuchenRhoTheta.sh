...
outFile=~/Jensen_response/analysis/Admixture_95CI_rho_${rho_in}_theta_${adaptive_theta}_selection_${selection}_DuchenRhoTheta_exactLength
...
python ~/Jensen_response/scripts/admixture_parameters_posteriorDistn_95CI_DuchenRhoTheta.py $rho_in $adaptive_theta $selection $locusLength $mu > ${file}_var
...
python ~/Jensen_response/scripts/Pi_MS_TajD.py ${file}_MS ${file}_pi_s_singletons
