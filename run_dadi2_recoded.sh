...
outFile=~/Jensen_response/analysis/dadi2_neutrality_recoded

for i in `seq 1 10000`; do

./msms/bin/msms 145 1 -N $Ne -t $theta -r $rho $locusLength -eN 0.1178203 0.5891016 -eN 0.1590574 1.472754 > $file
