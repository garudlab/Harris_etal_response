...
outFile=~/Jensen_response/analysis/dadi1_recoded_neutrality_MS

for i in `seq 1 100`; do

~/./msdir/ms  145 1 -t $theta -r $rho $locusLength -eN 0.2745424 0.003327787 -eN 0.2747088 1.663894 -seed $RANDOM $RANDOM $RANDOM> $file
