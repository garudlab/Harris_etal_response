...
outFile=~/Jensen_response/analysis/Admixture_95CI_rho_${rho_in}_theta_${adaptive_theta}_selection_${selection}_DuchenRhoTheta_exactLength_Xchr
...
python ~/Jensen_response/scripts/admixture_parameters_posteriorDistn_95CI_DuchenRhoTheta_Xchr.py $rho_in $adaptive_theta $selection $locusLength $mu > ${file}_var
