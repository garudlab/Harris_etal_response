...
outFile=~/Jensen_response/analysis/dadi2_neutrality

for i in `seq 1 10000`; do

./msms/bin/msms 145 1 -N $Ne -t $theta -r $rho $locusLength  -eN 0.22189 0.5888386 -eN 0.298009589 1.4720964> $file
