...
outFile=~/Jensen_response/analysis/Admixture_uniformPrior_rho_${rho_in}_theta_${adaptive_theta}_selection_${selection}

for i in `seq 1 10000`; do

echo $i
python ~/Jensen_response/scripts/admixture_paramters_uniformPrior.py $rho_in $adaptive_theta $selection $locusLength > ${file}_var
